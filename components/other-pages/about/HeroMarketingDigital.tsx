...
export default function HeroMarketingDigital() {
  return (
    <>
                  ...
                  <div className="mxd-block__content">
                    <div className="mxd-block__inner-headline">
                      <h1 className="inner-headline__title headline-img-before headline-img-06 loading__item">
                        El Marketing Digital que puedes necesitar
                      </h1>
                ...
                <div className="row g-0 d-flex">
                        ...
                        <div className="row g-0 fullheight-xl d-xl-flex flex-xl-column justify-content-xl-between">
                          ...
                          <div className="col-12 col-sm-6 col-xl-12 mxd-values__lists-item">
                            <ul>
                              ...
                              <li>
                                <p className="t-small anim-uni-in-up">Planeación</p>
                              </li>
                              <li>
                                <p className="t-small anim-uni-in-up">
                                  Diseño
                              ...
                              <li>
                                <p className="t-small anim-uni-in-up">Be Different</p>
                              </li>
                            </ul>
                          </div>
                        </div>
                  ...
                  <div className="col-12 col-xl-6 mxd-values__item order-3 order-xl-3 mobile-reverse mxd-grid-item no-margin animate-card-2">
                    ...
                    <div className="mxd-values__descr has-top-list anim-uni-in-up">
                      ...
                      >
                        Una manera efectiva de mejorar la presencia de tu marca o empresa en línea.
Las redes sociales son una herramienta clave para aumentar la visibilidad, generar engagement y fortalecer la reputación de tu marca en línea. Con una estrategia de Social Media Marketing bien estructurada, puedes llegar a una audiencia más amplia y convertir seguidores en clientes leales.

En la actualidad, tener presencia digital va más allá de solo publicar contenido, se trata de implementar estrategias optimizadas que incluyan:
                      </RevealText>
                    </div>
                  </div>
                </div>
