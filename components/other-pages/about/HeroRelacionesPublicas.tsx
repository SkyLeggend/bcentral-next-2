...
export default function HeroRelacionesPublicas() {
  return (
    <>
                  ...
                  <div className="mxd-block__content">
                    <div className="mxd-block__inner-headline">
                      <h1 className="inner-headline__title headline-img-before headline-img-06 loading__item">
                        Aumenta tu prescencia en el mercado
                      </h1>
                ...
                <div className="row g-0 d-flex">
                  ...
                  <div className="col-12 col-xl-6 mxd-values__item order-3 order-xl-3 mobile-reverse mxd-grid-item no-margin animate-card-2">
                    ...
                    <div className="mxd-values__descr has-top-list anim-uni-in-up">
                      ...
                      >
                        Nos aseguramos de que la comunicación sea de manera clara y 
                        consistente con tu audiencia objetivo, y de crear una estrategia 
                        personalizada con la que llegues a tus metas.<br></br> Establecemos relaciones 
                        con los medios de comunicación para obtener una cobertura de prensa positiva, 
                        lo que aumentará la visibilidad y el conocimiento de tu marca en el mercado.
                        Además, organizamos eventos y actividades para generar interés en tus productos o servicios y aumentar la conciencia de tu marca en la comunidad.
                      </RevealText>
                    </div>
                  </div>
                </div>
