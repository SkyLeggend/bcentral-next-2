                ...
                <div className="row g-0 d-flex">
                  ...
                  <div className="col-12 col-xl-6 mxd-values__item order-3 order-xl-3 mobile-reverse mxd-grid-item no-margin animate-card-2">
                    ...
                    <div className="mxd-values__descr has-top-list anim-uni-in-up">
                      ...
                      >
                        Somos una agencia especializada en <b>PR & Marketing Digital</b>, expertos en crear alianzas estratégicas que posicionan y potencian tu marca.

Ayudarte a conectar de manera auténtica con tu público, mejorar tu visibilidad y dejar una huella duradera en el entorno digital.

<br></br>Nuestra misión es clara:<br></br>
Ayudarte a conectar de manera auténtica con tu público, mejorar tu visibilidad y dejar una huella duradera en el entorno digital.
                      </RevealText>
                    </div>
                  </div>
