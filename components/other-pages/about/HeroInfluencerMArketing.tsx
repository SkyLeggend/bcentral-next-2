...
export default function HeroInfluencerMarketing() {
  return (
    <>
                  ...
                  <div className="mxd-block__content">
                    <div className="mxd-block__inner-headline">
                      <h1 className="inner-headline__title headline-img-before headline-img-06 loading__item">
                        Potencia tu marca con Influencer Marketing
                      </h1>
                  ...
                  <div className="col-12 col-xl-6 mxd-values__item order-3 order-xl-3 mobile-reverse mxd-grid-item no-margin animate-card-2">
                    ...
                    <div className="mxd-values__descr has-top-list anim-uni-in-up">
                      <RevealText
                        ...
                        Estrategia de marketing en la que colaboramos con 
                        influencers de considerable audiencia. <br></br>
                        El Influencer Marketing se ha convertido en una de 
                        las estrategias más efectivas para marcas que buscan 
                        aumentar su visibilidad, credibilidad y conversión en 
